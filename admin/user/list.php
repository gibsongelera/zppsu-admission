...
<script>
	$(document).ready(function(){
		$('.delete_data').off('click').on('click', function(e){
			e.preventDefault();
			// Close any open dropdown first so modal buttons are not blocked
	...
	function delete_user($id){
		// Properly hide modal and remove only one backdrop if exists
		if ($('#confirm_modal').hasClass('show')) {
