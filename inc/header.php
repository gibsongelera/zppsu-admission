<?php
// Only include header content, not session auth, for register page
include_once('inc/header_content.php'); // create this file with only the <head> section, no sess_auth.php
?>
<head>
  <style>
    :root{
  ...
  <link rel="stylesheet" href="<?php echo base_url ?>plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
    ...
    #main-header{
        position:relative;
        background: rgba(134, 3, 14, 1)!important;
